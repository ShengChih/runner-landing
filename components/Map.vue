<template>
  <svg width="254" height="166" viewBox="0 0 254 166" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle
      ...
      stroke-width="5"
    />
    <path d="M58.5058 100.256L43.5541 92.4805V106.132L58.5058 100.256Z" fill="#007FAB" />
    <path d="M43.5541 123.298V106.132M43.5541 106.132V92.4805L58.5058 100.256L43.5541 106.132Z" stroke="#007FAB" stroke-width="5" stroke-linejoin="round" />
  </svg>
</template>
